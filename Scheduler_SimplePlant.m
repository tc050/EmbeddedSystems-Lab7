...
metrics = table('Size',[1 10], ...
    'VariableTypes', ["double","double","double","double","double","double","double","double","double","double"], ...
    'VariableNames', ["overshoot_perc","steady_state_error","settling_time","rise_time","avg_loop_latency_ms","p95_loop_latency_ms", "p99_loop_latency_ms", "deadline_miss","miss_rate","jitter"]);
...
metrics.p99_loop_latency_ms(1) = mean(sorted_latency(steps*0.99:end));
